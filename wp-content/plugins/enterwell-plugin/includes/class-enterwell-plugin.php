...
class EnterwellPlugin {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      EnterwellPluginLoader $loader Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'enterwell-plugin';
		$this->version     = '1.0.0';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once PLUGIN_DIR . '/includes/class-enterwell-plugin-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once PLUGIN_DIR . '/includes/class-enterwell-plugin-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once PLUGIN_DIR . '/admin/class-enterwell-plugin-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once PLUGIN_DIR . '/public/class-enterwell-plugin-public.php';
		...
		// Load controllers
		require_once PLUGIN_DIR . 'controllers/class-aewstarter-controller.php';
		...
		$this->loader = new EnterwellPluginLoader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new EnterwellPlugini18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new EnterwellPluginAdmin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new EnterwellPluginPublic( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    EnterwellPluginLoader    Orchestrates the hooks of the plugin.
	 */
